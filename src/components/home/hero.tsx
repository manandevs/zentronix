...
const PlasmaGlobe = dynamic(() => import("@/components/shared/plasma-globe"), {
  ssr: false,
  loading: () => null,
});
  ...
  return (
    ...
    >
      ...
      >
        <a
          href="/chat"
          className="flex w-80 justify-between gap-1 rounded-full px-4 py-3 backdrop-blur-xl md:px-5 lg:w-100 shadow border border-white/25 bg-white/75"
        >
          <p className="text-sm font-semibold text-black">Launch Intelligence Console</p>
