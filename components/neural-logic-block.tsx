"use client";
import { PlayIconButton } from "./play-icon-button";
import { ScrollReveal } from "./scroll-reveal";

export function NeuralLogicBlock() {
  return (
    <ScrollReveal className="service-card isolate col-span-2 grid grid-cols-6 gap-6 pb-30 md:gap-4 md:px-8 md:pb-40 font-urbanist">
